    ...
    "cartItems": [
      {
        ...
        "updated_at": "2025-12-16T07:00:00Z"
      }
    ],
    "summary": {
      "selectedCount": 1,
...
#### 批量更新购物车商品选中状态
```http
PUT /api/cart/batch-update-selection
Authorization: Bearer <token>
Content-Type: application/json
...
CREATE INDEX idx_cart_user_selected ON cart(user_id, is_selected);
